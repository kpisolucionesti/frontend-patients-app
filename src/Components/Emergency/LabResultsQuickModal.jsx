            ...
            <Table size="small" sx={{ minWidth: 500 }}>
              <TableHead>
                <TableRow sx={{ bgcolor: theme.palette.primary.main }}>
                  <TableCell sx={{ fontSize: '0.7rem', fontWeight: 600, p: 0.5, position: 'sticky', left: 0, bgcolor: theme.palette.primary.main, color: theme.palette.primary.contrastText, zIndex: 2, minWidth: 130 }}>Parámetro</TableCell>
                  <TableCell sx={{ fontSize: '0.7rem', fontWeight: 600, p: 0.5, position: 'sticky', left: 130, bgcolor: theme.palette.primary.main, color: theme.palette.primary.contrastText, zIndex: 2, minWidth: 80 }}>Ref</TableCell>
                  <TableCell sx={{ fontSize: '0.7rem', fontWeight: 600, p: 0.5, position: 'sticky', left: 210, bgcolor: theme.palette.primary.main, color: theme.palette.primary.contrastText, zIndex: 2, minWidth: 60 }}>Unidad</TableCell>
                  {sortedResults.map((r) => (
                    <TableCell key={r.id} sx={{ fontSize: '0.7rem', fontWeight: 600, p: 0.5, textAlign: 'center', minWidth: 110, whiteSpace: 'nowrap', bgcolor: theme.palette.primary.main, color: theme.palette.primary.contrastText }}>
