                ...
                <TableContainer>
                    <Table size='small'>
                        <TableHead sx={{ textAlign: "center", bgcolor: "darkblue" }} >
                            <TableRow>
                                <TableCell sx={{ borderColor: 'white', border: 3, textAlign: 'center', color: 'white', p: 1, pl: 2, fontSize: 20, maxWidth: 60, minWidth: 60 }} >UBICACIÓN</TableCell>
                                <TableCell sx={{ borderColor: 'white', border: 3, textAlign: 'center', color: 'white', p: 1, pl: 2, fontSize: 20, maxWidth: 60, minWidth: 60 }} >PACIENTE</TableCell>
                                <TableCell sx={{ borderColor: 'white', border: 3, textAlign: 'center', color: 'white', p: 1, pl: 2, fontSize: 20, maxWidth: 15, minWidth: 15 }} >EDAD</TableCell>
                                <TableCell sx={{ borderColor: 'white', border: 3, textAlign: 'center', color: 'white', p: 1, pl: 2, fontSize: 20, maxWidth: 150, minWidth: 150 }} >DIAGNÓSTICO</TableCell>
                                <TableCell sx={{ borderColor: 'white', border: 3, textAlign: 'center', color: 'white', p: 1, pl: 2, fontSize: 20, maxWidth: 100, minWidth: 100 }} >MÉDICO TRATANTE</TableCell>
                                <TableCell sx={{ borderColor: 'white', border: 3, textAlign: 'center', color: 'white', p: 1, pl: 2, fontSize: 20, maxWidth: 150, minWidth: 150 }}>PLAN</TableCell>
                            </TableRow>
                        </TableHead>
