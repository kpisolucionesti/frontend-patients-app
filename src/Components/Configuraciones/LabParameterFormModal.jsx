...
const LabParameterFormModal = ({ open, onClose, param, groups, onSaved }) => {
  const isEdit = !!param;
  const [values, setValues] = useState({
    name: '', unit: '', abbreviation: '', lab_parameter_group_id: '',
  ...
  return (
    <Dialog fullWidth maxWidth="sm" open={open} onClose={onClose}>
      ...
      <DialogActions sx={{ p: 2 }}>
        ...
        <Button onClick={handleSave} variant="outlined" color="success" disabled={saving || !values.name.trim()}>
