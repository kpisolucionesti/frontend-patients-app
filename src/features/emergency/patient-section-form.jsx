import { Box, IconButton, Stack, TextField, Tooltip, Typography, Grid } from "@mui/material";
...
const PatientSection = ({ values, locked, validation, onCiChange, onFieldChange, onBirthdayChange, onEditClick }) => {
  ...
  return (
    <Box>
      ...
      <Stack spacing={1.5}>
        {/* Row 1: Cédula + Nro. Historia — IDs compactos */}
        ...
        {/* Row 3: Nombre — full width, puede ser largo */}
        <TextField
          variant="standard"
          size="small"
          disabled={locked}
